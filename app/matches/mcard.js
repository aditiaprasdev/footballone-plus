...
export default function MCard({
  ...
  return (
    <>
      <div className="grid grid-cols-6 gap-3 w-full py-4 pl-3 hover:shadow-lg hover:border-black border dark:bg-zinc-800 dark:border-zinc-800 dark:hover:border-zinc-500 rounded-md justify-between hover:transition hover:ease-in-out hover:duration-200">
